/*
Practica 2
Jorge Vazquez Guzman 372504
9 de septiembre
Menu con 3 opciones de codigos
Practica 2 tipos de operadores y expresiones
*/
...
int main()
{
    ...
    // Seleccion de accion en el menu
    switch (op)
    {
    case 1:
        ...
        for (int j = i - 1; j >= 0; j--)
        { // esto imprime el numero como tal
            if (bin[j] == 1)
            {
    ...
    case 3:
        ...
        do
        {
            ...
            // Agrega articulos al inventario
            if (opinv == 1)
            {
            ...
            // Retira articulos al inventario
            else if (opinv == 2)
            {
            ...
            // Revisa la cantidad de objetos del inventario
            else if (opinv == 3)
            {
